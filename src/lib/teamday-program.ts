...
export type TeamdayScriptBlock = {
  label: string;
  lines: string[];
};

export type TeamdayActivity = {
  id: string;
  title: string;
  durationSec?: number;
  description?: string;
...
export type TeamdaySession = {
  ...
  attendees?: string[];
  overview?: string[];
  script?: TeamdayScriptBlock[];
  activities?: TeamdayActivity[];
  transitions?: string[];
  reflection?: string[];
  notes?: string[];
};

export const TEAMDAY_META: TeamdayMeta = {
...
export const TEAMDAY_SESSIONS: TeamdaySession[] = [
  {
...
export const FACILITATOR_TIPS: string[] = [
